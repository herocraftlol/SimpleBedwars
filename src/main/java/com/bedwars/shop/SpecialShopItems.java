...
public final class SpecialShopItems {
    ...
    public static final List<ShopItem> POTIONS = List.of(
            ShopItem.potion("Potion de Force (20s)", PotionType.STRENGTH, 20, Material.EMERALD, 2),
            ShopItem.potion("Potion de Vitesse (20s)", PotionType.SWIFTNESS, 20, Material.EMERALD, 2),
            ShopItem.potion("Potion d'Invisibilité (20s)", PotionType.INVISIBILITY, 20, Material.EMERALD, 2),
    ...
    public static final List<ShopItem> RANGED_EXTRA = List.of(
            ShopItem.enchantedItem(Material.BOW, "Arc (Puissance I)", Material.GOLD_INGOT, 24,
